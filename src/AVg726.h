...
class AVg726 {
 ...
 public:
  ...
  int decodec(char* pSrcData, int nDataLen, char* pAmpData) {
    ...
    int ampLen = g726_decode(_stat, (int16_t*)pAmpData,
                             (const uint8_t*)g726Data, nDataLen - KFlagHisiLen);
  ...
  int encodec(char* pAmpData, int nDataLen, char* pG726Data) {
    ...
    int g726Len = g726_encode(_stat, (uint8_t*)g726Data, (int16_t*)pAmpData,
                              nDataLen / (sizeof(int16_t)));
